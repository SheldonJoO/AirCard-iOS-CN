    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_exploit_run 中发生 panic：{e:?}"));
            }
            1
        }
    }
...
pub unsafe extern "C" fn al_exploit_write_dir(
    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_exploit_write_dir 中发生 panic：{e:?}"));
            }
            1
        }
    }
...
pub unsafe extern "C" fn al_exploit_inject_folder(
    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_exploit_inject_folder 中发生 panic：{e:?}"));
            }
            1
        }
    }
...
pub unsafe extern "C" fn al_syslog_stream_start(
    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_syslog_stream_start 中发生 panic：{e:?}"));
            }
            1
        }
    }
...
pub unsafe extern "C" fn al_find_app_container(
    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_find_app_container 中发生 panic：{e:?}"));
            }
            1
        }
    }
...
pub unsafe extern "C" fn al_device_respring(
    ...
    match res {
        ...
        Err(e) => {
            if !out_error.is_null() {
                *out_error = ffi_util::cstr(format!("Rust 在 al_device_respring 中发生 panic：{e:?}"));
            }
            1
        }
    }
